""" There is symmetry and moves that lead to an infinite graph, such as four rotations then four rotations of the same move, of the 6 times 3 turn moves. Matrix representation and coordinates of reference, directional inference. Rotation moves not completely done. Just a start done in time of the first 30 minutes after NYE 2023 Jan 1st 2024. Matrix system eventually working in all rotations of the Rubiks (3 * 6) * (3 * 5) subsequent moves """
